							...
							<div class="card-footer">
								<div class="row">
									<div class="col-lg-2 col-xs-4">
										<button type="submit" class="btn btn-block btn-flat" style="background-color: #103f7dff; color:white;">Create</button>
									</div>
									<div class="col-lg-2 col-xs-4">
										<a href="{{ route('products.index') }}" class="btn btn-block btn-flat" style="background-color: #103f7dff; color:white;">Back</a>
									</div>
								</div>
							</div>
						</form>
