	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-header" style="font-size: 1.75rem;font-weight: 500; line-height: 1.2; margin-bottom: 0.5rem; background-color: #103f7dff; color:white;">
							@yield('title')

							<a href="{{ route('products.create') }}" class="btn btn-light float-right" title="Nuevo"><i style="color: #103f7dff;" class="fas fa-plus nav-icon"></i></a>
